...
const structure = [
  ...
  { id: 1, label: 'Person', link: '/app/person', icon: <PersonIcon /> },
  { id: 2, label: 'Movie', link: '/app/movie', icon: <MovieIcon/> },
  { id: 3, label: 'category', link: '/app/category', icon: <CategoryIcon />},
  { id: 4, label: 'subcategory', link: '/app/subcategory', icon: <CategoryIcon />},
